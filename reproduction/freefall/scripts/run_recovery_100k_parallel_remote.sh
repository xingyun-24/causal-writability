...
SHARD=${1:?usage: run_recovery_100k_parallel_remote.sh SHARD GPU}
GPU=${2:?usage: run_recovery_100k_parallel_remote.sh SHARD GPU}
...
RUN=hist16-step100000-recovery128-e3-par32
OUT="$ROOT/results/$RUN/shard$SHARD"
MANIFEST="$ROOT/results/$RUN/manifests/recovery_pairs_shard$SHARD.json"
CHECKPOINT="$ROOT/checkpoints/short-v3-large-fixedpos-horizontal-hist16/hist16/step-100000.safetensors"
