...
SHARD=${1:?usage: run_recovery_hist32_parallel_remote.sh SHARD GPU}
GPU=${2:?usage: run_recovery_hist32_parallel_remote.sh SHARD GPU}
...
RUN=hist32-step50000-recovery128-e3-par8
OUT="$ROOT/results/$RUN/shard$SHARD"
MANIFEST="$ROOT/results/$RUN/manifests/recovery_pairs_shard$SHARD.json"
CHECKPOINT="$ROOT/checkpoints/short-v3-large-fixedpos-horizontal-hist32/hist32/step-50000.safetensors"
