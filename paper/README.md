...
the source for new page copy or reported results.

Compile with pdfLaTeX, BibTeX, then pdfLaTeX twice. Do not mix the author blocks
between the preprint and anonymous version.
