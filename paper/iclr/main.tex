...
\usepackage{url}
\input{macros.tex}
\input{figures/figure_style.tex}
...
\author{%
Xingyun Wang\thanks{These authors contributed equally.} \And
Haomin Zheng\textsuperscript{*} \And
Man Yuan
\AND
Leqian Yang \And
Ziming Liu$^{\dagger}$
...
\begin{figure*}[t]
    \centering
    \ifdefined\figureoneoriginal
      \includegraphics[trim=0 9.32pt 0 0,clip,width=\textwidth]{figures/generated/figure1_final.pdf}
    \else
...
(Appendix~\ref{app:writability-robustness}).
...
\appendix
\input{appendix_revision_20260822.tex}
\end{document}
