    ...
    <main>
      <header className="topbar">
        ...
        <div className="topMeta">
          {import.meta.env.DEV && <span className="statusDot">Local preview</span>}
      ...
      <section className="section dark" id="choice">
        ...
        <div className="landscapePair">
          <article><div><span>FIGURE 2A · SLOW HISTORY</span><h3>Selection under slow physical evidence</h3><p>As the input cue changes from red to blue, decoded futures move from the slow mode through an intermediate region toward the fast mode.</p></div><a href={assetUrl("/paper/vector/fig2a-slow.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig2a-slow.svg")} width="600" height="404" alt="Decoded cue sweep for slow physical histories"/></a></article>
          <article><div><span>FIGURE 2A · FAST HISTORY</span><h3>Selection under fast physical evidence</h3><p>The corresponding sweep under fast history separates the effect of cue strength from the direction of the physical evidence.</p></div><a href={assetUrl("/paper/vector/fig2a-fast.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig2a-fast.svg")} width="540" height="404" alt="Decoded cue sweep for fast physical histories"/></a></article>
        </div>
      ...
      <section className="section" id="rewrite">
        ...
        <div className="triptych">
          <article><span>FIGURE 3B · TARGET FAST</span><h3>Fast-route coordinates vary with boundary phase</h3><a href={assetUrl("/paper/vector/fig3b-fast-phase.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig3b-fast-phase.svg")} width="370" height="410" alt="Fast-route coordinates organized by boundary phase"/></a><p>The frozen coordinates trace a smooth phase-dependent family.</p></article>
          <article><span>FIGURE 3B · TARGET SLOW</span><h3>Slow-route coordinates form a complementary family</h3><a href={assetUrl("/paper/vector/fig3b-slow-phase.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig3b-slow-phase.svg")} width="420" height="410" alt="Slow-route coordinates organized by boundary phase"/></a><p>The opposite target direction remains structured by the same low-order boundary variables.</p></article>
          <article><span>FIGURE 3B · LOW-RANK EFFECT</span><h3>Four coordinates retain nearly full recovery</h3><a href={assetUrl("/paper/vector/fig3b-recovery.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig3b-recovery.svg")} width="330" height="380" alt="Recovery retained by a four-dimensional edit"/></a><p>The four-dimensional edit approaches the decoded effect of the complete matched difference.</p></article>
        </div>
        <div className="controllerGrid">
          <figure><a href={assetUrl("/paper/vector/fig3c-controller-model.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig3c-controller-model.svg")} width="450" height="340" alt="Fit-only boundary-phase controller"/></a><figcaption><span>FIGURE 3C · CONTROLLER</span><strong>Direction chooses the route; phase locates the state</strong><p>For each requested direction, the controller uses [1, cos θ*, sin θ*] to predict the top-four route coordinates from input-boundary phase.</p></figcaption></figure>
          ...
          <figure><a href={assetUrl("/paper/vector/fig3c-controller-replay.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig3c-controller-replay.svg")} width="610" height="440" alt="Held-out decoded replay after controller intervention"/></a><figcaption><span>FIGURE 3C · DECODED EFFECT</span><strong>The alternative continuation is recovered</strong><p>The intervention changes the final pixel trajectory under fixed receiver input and noise.</p></figcaption></figure>
        </div>
      ...
      <section className="section dark" id="realize">
        ...
        <div className="panelGrid mechanismGrid">
          <article><a href={assetUrl("/paper/vector/fig5a-persistence.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig5a-persistence.svg")} width="690" height="300" alt="Target-route response after direct writeability closes"/></a><div><span>FIGURE 6A · PERSISTENCE</span><h3>The target-route signal persists after direct rewrite closes</h3><p>Route-aligned target responses remain measurable after condition-side frequency writeability has closed.</p></div></article>
          <article><a href={assetUrl("/paper/vector/fig5b-transfer.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/vector/fig5b-transfer.svg")} width="460" height="230" alt="Cross-run causal coordinate transfer"/></a><div><span>FIGURE 3D · CROSS-RUN TRANSFER</span><h3>Causal coordinates transfer across independent runs</h3><p>All six directed run-pair transfers achieve decoded recovery R = .94–.99 using fit-only scale and rotation.</p></div></article>
        </div>
        <FigurePanel label="FIGURE 6B · PATH RESTORATION" title="Restoring conflict K/V erases recovery" src="/paper/vector/fig5c-kv.svg" width={1180} height={320} alt="Restoration of conflict keys and values erasing causal recovery">
        ...
        <FigurePanel label="FIGURE 6C · SINGLE-HEAD INTERVENTION" title="One value head exhibits a finite causal margin" src="/paper/vector/fig5d-head.svg" width={1250} height={340} alt="Dose response of a single value-head intervention" reverse>
        ...
        <div className="fmTimingSection" id="fm-timing">
          ...
          <figure className="fmTimingFigure">
            <a href={assetUrl("/paper/appendix/figure-31.svg")} target="_blank" rel="noreferrer"><img src={assetUrl("/paper/appendix/figure-31.svg")} alt="On the same 48 trajectories, early calls 0–9 produce an internal response but little decoded recovery; late calls 10–19 recover motion, and all calls 0–19 improve recovery further." loading="lazy"/></a>
            <figcaption>The same gain-8 condition-V/head-8 write is applied to the same 48 receivers. Early-only writing changes the internal route response but is nearly ineffective in the decoded motion. Late-call writing restores motion; writing over all calls improves recovery further. An internal response alone does not establish control over the final generation. <a href={assetUrl("/paper/main.pdf#page=33")} target="_blank" rel="noreferrer">Figure 31 and methods ↗</a></figcaption>
          </figure>
